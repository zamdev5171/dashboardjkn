                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Tambah Kedudukan Katil </h4>
                                     <form action="{{ route('add/hospital/save') }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                    
                                        <div class="form-group">
                                            <label class="form-label">Lokasi</label>
                                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" value="{{ old('lokasi') }}" name="lokasi" id="hospital">
                                            @error('lokasi')
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('bilangan') is-invalid @enderror" value="{{ old('bilangan') }}" name="bilangan" id="hospital">
                                            @error('bilangan')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
