...
<div id="main-wrapper">
    ...
    <div class="nav-header">
        <a href="{{ route('home') }}" class="brand-logo">
            ...
            <img class="brand-title" src="{{ URL::to('assets/images/logo_white.png') }}" alt="">
        </a>
   ...
   <!-- sidebar -->
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="" target="_blank">ICT@JKNWP_Labuan</a> 2024</p>
        </div>
    </div>
</div>
</div>
