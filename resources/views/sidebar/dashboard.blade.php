    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                                ...
                                @if (Auth::user()->role_name=='Editor 1')
                             
                                <span class="nav-text">  EDITOR LEVEL 1 </span> 
                                @endif

                                 @if (Auth::user()->role_name=='Editor 2')
                             
                                <span class="nav-text">  EDITOR LEVEL 2 </span> 
                                @endif
                         </a>
            ...
            <li>
             ...
             <li>
              ...
              <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Kemudahan Utama</span>
                </a>
                <ul aria-expanded="false">
             ...
             <li>
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Kemudahan Hospital</span>
                </a>
                <ul aria-expanded="false">
             ...
             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="la la-bed"></i>
                    <span class="nav-text">Katil-Hospital</span>
                </a>
                <ul aria-expanded="false">
             ...
             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
              ...
              <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">No Telefon</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('all/phone/list') }}">Kemaskini</a></li>
                    <li><a href="{{ route('add/phone/new') }}">Cipta</a></li> 
                </ul>
            </li>
         ...
         @if (Auth::user()->role_name=='Editor 1')
             ...
             <li>
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="la la-stethoscope"></i>
                    <span class="nav-text">Kakitangan/Perjawatan</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('all/jawatan/list') }}">Kemaskini</a></li>
                   <li><a href="{{ route('add/jawatan/new') }}">Cipta</a></li>  
         ...
         @endif
           ...
           @if (Auth::user()->role_name=='Editor 2')
             ...
             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="la la-bed"></i>
                    <span class="nav-text">Kedudukan Semasa Katil</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('all/hospital/list') }}">Kemaskini</a></li>
                    <li><a href="{{ route('add/hospital/new') }}">Cipta</a></li> 
