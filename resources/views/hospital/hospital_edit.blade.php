        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Kedudukan Penggunaan Katil</a></li>
                        ...
                        <div class="authincation-content">
                            <div class="row no-gutters">
                                <div class="col-12">
                                    <div class="auth-form">
                                    <div>
                                     <h4 class="text-center mb-4">Kemaskini Kedudukan Penggunaan Katil Hospital</h4>
                                     </div>
                                     <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('') is-invalid @enderror" value="{{ $hospital[0]->katil}}" name="katil" id="hospital">
                                            @error('katil')
                                            ...
                                            <input type="hidden" name="id" value="{{ $hospital[0]->id }}">
                                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror" value="{{ $hospital[0]->jumlah}}" name="jumlah" id="hospital">
                                            @error('jumlah')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
