...
@section('content')
        ...
        <!-- row -->
        <div class="container-fluid" style=" width:100%; height:100vh; padding:0px; margin:0px; overflow:hidden">
            ...
            <section class="row" >
                <div class="col-xl-2 col-xxl-2 col-sm-6" >
                    ...
                    <div class="table-responsive">
                     ...
                     <div class="card card-table flex-fill">
                           <div class="card-header">
                            <h4 class="card-title"> <img style= "width:50px; height:55px" src="{{ URL::to('assets/icons/fasiliti.svg') }}">KEMUDAHAN UTAMA </h4> 
                           </div>
                        <div class="card-body">
                        <div class="table-responsive">
                                <table class="table hover table-striped table-light">
              ...
              <div class="col-xl-2 col-xxl-2 col-sm-6">
               ...
               <div class="col-xl-4 col-xxl-4 col-sm-6" >
                    <div class="widget-stat card bg-white"style="height:100%">
                 ...
                 <div class="col-xl-4 col-xxl-4 col-sm-6" style="height:100%">
                    <div class="widget-stat card bg-white">
                        <div class="card card-table flex-fill">
                          <div class="card-header">
